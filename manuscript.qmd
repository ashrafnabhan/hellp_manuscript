...
Asmaa Fahmy Kasem, Hamdy Bakry Alqenawy, Rania Gamal, Marwa Abd Elmawla Elgendi, Yasser M. Elrefaey, Rowyna Hany Mohamed El Helw, Rania Hassan Mostafa Ahmed, Radwa Rasheedy, Mohammad Nahel Sorour, Mohamed Sameh Elsewefy, Maya M. Abdelrazek, Mohamed Yasser Galal Albahaie, Khadiga Mostafa Hussein Hegab, Mohamed Salama, Ashraf Nabhan
...
Address: Department of Obstetrics and Gynecology, Faculty of Medicine, Ain Shams University, Ramses Street, Cairo, Egypt
...
**Results**: Fifteen trials (821 women) compared corticosteroids with placebo or no treatment. The effect of corticosteroids is uncertain for the primary outcome i.e., maternal death (risk ratio 0.77, 95% confidence interval 0.25 to 2.38, very low certainty evidence). The effect of corticosteroids is also uncertain for other important outcomes including pulmonary edema, dialysis, liver morbidity, or perinatal death because of very low certainty evidence. Low certainty evidence suggests that corticosteroids have little or no effect on platelet transfusion (risk ratio 0.9821; 95% confidence interval 0.6031 to 1.5994) and may result in a slight reduction in acute renal failure (risk ratio 0.6658; 95% confidence interval 0.3965 to 1.1179)
...
The syndrome of hemolysis, elevated liver enzymes and low platelets (HELLP) has an incidence of 2.5 per 1000 singleton deliveries and It complicates 20% of severe pre‐eclampsia. [@lisonkova2020; @haram2009]
...
The diagnosis of HELLP syndrome depends on laboratory findings of microangiopathic hemolysis, thrombocytopenia, and elevated liver enzymes. Different investigators reported different threshold of hematologic and biochemical values for diagnosis of the syndrome or for determining the prognosis. [@adorno2022; @sibai2004]

The presence of HELLP syndrome is associated with significant maternal mortality and morbidity including acute renal and liver failure. @lisonkova2020

Approximately 70% of pregnancies complicated by HELLP syndrome require preterm delivery, thus increasing perinatal morbidity and mortality. @sibai2004
...
Current practice and clinical guidelines require an updated evidence synthesis because the available synthesis of evidence was published in 2010 [@Woudstra2010], new studies have been published, and the clinical question remains relevant to decision makers.
...
For eligible studies, two authors extracted the data in duplicates using an offline electronic form. We resolved discrepancies through discussion. Extracted data were transcribed to a spreadsheet and checked for accuracy. We contacted authors of the original reports to provide further details regarding unclear or missing data.
...
Two authors independently used the Risk of Bias 2 (RoB 2) tool to assess the risk of bias of study results contributing information to each of the outcomes specified for inclusion in the summary of findings tables.
...
![Maternal death: Corticosteroids vs placebo or no treatment](fig2.jpg){#fig-md}
...
![Acute pulmonary edema: Corticosteroids vs placebo or no treatment](fig3.jpg){#fig-pe}
...
![Acute renal failure: Corticosteroids vs placebo or no treatment](fig4.jpg){#fig-rf}
...
Corticosteroids, compared with placebo or no treatment, may result in a slight reduction in acute renal failure. We downgraded the certainty of the evidence two levels to low due to very serious imprecision. The 95% CI overlaps no effect and includes both large benefit.
...
The results of this up-to-date review are consistent with the findings reported previously @Woudstra2010. They concluded that there was insufficient evidence to support the administration of corticosteroids to women with HELLP syndrome.

In this review, we only included randomized controlled trials (RCTs) for the meta-analysis. Observational studies were excluded to ensure reliability of the results by minimizing the risk of bias due to unmeasured confounders. A major issue of observational evidence is that it is known to have limited internal validity as it is subject to both bias and confounding. Overall, observational study designs are not the most appropriate to assess the causal relationship between an intervention and an outcome as several characteristics might differ or might change over time between the different intervention groups. So, the inclusion of observational studies in a meta-analysis might introduce bias in the summary effect. Potential biases are likely to be greater for observational studies compared with randomized trials when evaluating the effects of interventions. Observational studies of interventions vary in their ability to estimate a causal effect. Biases affecting pbservational studies of interventions vary depending on the features of the studies. Published reviews @mao2015 that included observational studies have failed to address potential confounders and the likelihood of increased heterogeneity resulting from residual confounding and from other biases that vary across studies.

Our strategy aimed to study the effectiveness of corticosteroids for HELLP syndrome regarding critical maternal and perinatal outcomes instead of surrogate outcomes, which may provide insights into disease mechanisms rather than reflecting clinically meaningful outcomes relevant to decision making. Surrogate outcome measures, such as laboratory results are potentially misleading and should be avoided or interpreted with caution because they may not predict clinically important outcomes accurately. Surrogate outcomes may provide information on how a treatment might work but not whether it actually does work. Many interventions reduce the risk for a surrogate outcome but have no effect or have harmful effects on clinically relevant outcomes, and some interventions have no effect on surrogate measures but improve clinical outcomes @Bucher2015; @cochrane2023ch3. Despite the potential appeal of surrogates, for example the change in platelet count and liver enzymes, these laboratory markers might not reflect the actual effects that corticosteroids have on critical outcomes of women with HELLP syndrome. Superiority on a surrogate end point may not translate into benefits for patients. Further, the use of surrogate end points means that decision makers must extrapolate from these findings to estimate the true benefits to patients. This results in uncertainty about the effect of corticosteroids in HELLP syndrome. Published synthesized evidence @mao2015 that included surrogate outcomes without downgrading the certainty of evidence for indirectness would definitely provide misleading implications for practice. It may not be justifiable or acceptable to use surrogate outcomes for a review when validated or evaluated true endpoints are available @tufanaru2016.

We also focused on studies that compared corticosteroids to placebo or standard care. Comparing various types of corticosteroids, which differ in their relative potency and duration of action, to each other would not be clinically useful if none of them are superior to placebo. It is neither intuitive nor correct to compare one corticosteroid to another when evidence fails to show a difference between any corticosteroid vs placebo or no treatment. Investigators @basaran2012 raised serious doubts regarding the credibility of the subgroup analysis results of the Cochrane review @Woudstra2010 and the application of these subgroup results into clinical practice.
...
A limitation of the evidence was the limited number of outcomes reported in included trials. Most included trials reported surrogate laboratory results. The possibility of reporting bias could not be excluded, as not all trials reported all relevant outcomes. Patient relevant outcomes in HELLP syndrome do not require exceptional training, expensive tools, or long follow up. It does not seem comprehensible to conduct a trial in such a critical condition without reporting maternal death or morbidity.
...
Figure 1 PRISMA flow diagram. PRISMA, Preferred Reporting Items for a Systematic review and Meta-analysis
