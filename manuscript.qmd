...
Six trials (449 women) reported maternal death. The risk of bias for the included RCTs contributing results to maternal death ia available in the [Supplemental file 4]. The risk ratio (RR) was 0.77 (95% confidence intervals (CI) 0.25 to 2.38, @fig-md). The effect of any corticosteroid vs placebo or no treatment is uncertain. We downgraded the certainty of the evidence to very low due to extremely serious imprecision, @tbl-grade.
